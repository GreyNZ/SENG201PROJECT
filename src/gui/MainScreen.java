...
import main.RepairShip;
import main.Ship;
import outpost.ConsumeItem;
...
public class MainScreen {
	...
	public void refreshOwnedItems() { 
		...
		String f = "";
		if (comboBoxHealItem.getItemCount() == 0) {
			lblHealingOwnedItems.setText("No Healing items owned");
			lblItemInfo.setText("");
		}
		else {
		...
		if (comboBox_SelectFood_CrewTab.getItemCount() == 0) {
			lblFoodItemsOwned.setText("No Food items owned"); 
			lblFoodInfo.setText("");
		}
		else {
	...
	public void refreshShipHealth() {
		...
		String hullFormat = "Hull:  %.0f/100";
		String shieldFormat = "Shields:  %.0f/100";
